		...
		<div class="space-y-6">
			...
			<div class="flex items-center gap-3">
				...
				<button
					...
					class="inline-flex items-center gap-2 px-4 py-3 rounded-lg border transition-colors {liked ? 'bg-red-500/10 border-red-500 text-red-500' : 'bg-[var(--bg-secondary)] border-[var(--border-color)] text-[var(--text-secondary)] hover:border-red-500 hover:text-red-500'}"
					title={liked ? 'Unlike this showcase' : 'Like this showcase'}
				>
